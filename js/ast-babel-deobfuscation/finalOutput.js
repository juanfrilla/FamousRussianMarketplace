(function () {
  ...
  (function (A, t) {
    ...
    while (true) {
      try {
        if (parseInt(c(188)) / 1 + -parseInt(c(383)) / 2 * (-parseInt(c(529)) / 3) + -parseInt(c(653)) / 4 + parseInt(c(459)) / 5 + parseInt(c(420)) / 6 * (-parseInt(c(363)) / 7) + parseInt(c(573)) / 8 * (-parseInt(c(523)) / 9) + parseInt(c(329)) / 10 === 636439) {
          break;
        }
        e.push(e.shift());
      } catch (A) {
  ...
  (function () {
    ...
    var _0x23ee05 = _0x58f901(this, function () {
      var A = _0x1206;
      return _0x23ee05.toString().search("(((.+)+)+)+$").toString().constructor(_0x23ee05).search("(((.+)+)+)+$");
    });
    var _0xe83a3c;
    _0x23ee05();
    _0x16ad01 = true;
    function _0x56aa45(A, t) {
      var c = _0x16ad01 ? function () {
        var c = _0x1206;
        if (t) {
          var e = t.apply(A, arguments);
          t = null;
    ...
    var _0x30cd1f = _0xad0626(this, function () {
      ...
      for (var e = ["log", "warn", "info", "error", "exception", "table", "trace"], n = 0; n < e.length; n++) {
    ...
    function _0x1a6645() {
      ...
      function a(e, n, r, a) {
        ...
        _0x16bd43(l, "_invoke", function (c, e, n) {
          var r;
          var a;
          var i;
          var C = B;
              ...
              try {
                ...
                if (r) {
                  ...
                  if (t = r[n]) {
                    ...
                    if (a < 2) {
                      i = TypeError("The iterator does not provide a '" + n + "' method");
                      a = 1;
                    }
                  }
                  r = A;
      ...
      var l = [][n] ? t(t([][n]())) : (_0x16bd43(t = {}, n, function () {
        return this;
      }), t);
    ...
    function _0x247740(A) {
      var t = _0x1206;
      return (_0x247740 = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (A) {
        return typeof A;
      } : function (A) {
        var c = t;
        if (A && "function" == typeof Symbol && A.constructor === Symbol && A !== Symbol.prototype) {
          return "symbol";
        } else {
          return typeof A;
        }
    ...
    function _0x24e8e3() {
      ...
      try {
        if (!(t = window.navigator.cookieEnabled)) {
          ...
          document.cookie = "".concat(_0x50c536, "=1; expires=Thu, 01-Jan-1970 00:00:01 GMT");
        }
        return t;
      } catch (A) {
        return false;
    ...
    function _0x318db2() {
      ...
      var i = document.querySelector("#complain-new-window")?.value === "true" ? "_blank" : "_self";
      var B = document.createElement("main");
      B.innerHTML = '\n<div class="sec bl" id="content">\n  <div class="cnt">\n    <img class="img" src="https://cdn2.FaMouSRuSSiaNMaRKeTPLaCe.CoM/s3/abt-challenge/incidents/images/warn.png" alt="warning">\n    <div class="title">Похоже, нет&nbsp;соединения</div>\n    <div class="sign">\n      Выключите VPN, перезагрузите роутер или&nbsp;подключитесь к&nbsp;другой сети\n    </div>\n  </div>\n  <div class="inc">Инцидент: '.concat(a, "</div>\n  <div class=\"btns\">\n    <button class=\"btn rb\" id=\"reload-button\">\n      Обновить страницу\n    </button>\n    <a class=\"btn sb\" href=\"https://www.famousrussianmarketplace.ru/complaint/support/?incident_id=").concat(a, "&platform=web&token=").concat(o, "&back_url=/\" target=\"").concat(i, "\">\n      Обратиться в поддержку\n    </a>\n  </div>\n</div>\n  ");
      r.remove();
      document.body.append(B);
      if ((e = document.querySelector("#reload-button")) !== null && e !== undefined) {
    ...
    function _0x48abfb() {
      ...
      var r = _0x5a7476(_0x5a7476(_0x5a7476({}, _0x1d0bd4, _0x12d933), _0x48e13d, _0x43e406), _0x204882, n);
      if (c) {
    ...
    function _0x26efc6(A, t, c) {
      ...
      if (n.length <= t) {
        ...
        return "".concat(n.slice(0, Math.ceil(t / 2)), "...").concat(n.slice(-Math.floor(t / 2)));
      } else {
    ...
    function _0x3acba0(A) {
      ...
      if (A != null && _0x247740(A) === "object" && A.message) {
        ...
        var e = A.stack;
        if (typeof e === "string") {
          c.stack_trace = _0x26efc6(e.split(window.location.href).join(""), 1024);
        } else {
        ...
        c.message = A != null ? _0x26efc6(A, 1024) : "Cross origin script error";
      }
      return c;
    }
    window.addEventListener("load", _0x152c94);
    _0x10079d = _0x433d14(_0x1a6645().m(function A(t, c, e) {
      var n;
      var r;
      var a;
      var o;
      var i;
      return _0x1a6645().w(function (A) {
        var B = _0x1206;
        for (;;) {
          switch (A.p = A.n) {
            case 0:
    ...
    function _0x505812(A, t) {
      var c = _0xc52c7c;
      if ((A.passed || A.retryable) && window.location.pathname !== "/challenge.html") {
    ...
    function _0x3bf81b() {
      setTimeout(function () {
        ...
        if (t) {
          window.parent.postMessage("{ \"formHeight\": \"".concat(t.offsetHeight + _0x5de696(5), '" }'), "*");
        }
      }, 200);
    }
    function _0x348336() {
    ...
    function _0x5b9f4e() {
      return (_0x5b9f4e = _0x433d14(_0x1a6645().m(function A(t) {
        var n;
        var r;
        var a;
        var o;
          ...
          for (;;) {
            switch (A.p = A.n) {
              case 0:
                ...
                n = _0x48abfb();
                r = _0x33b2c3(_0x33b2c3({}, t), {}, {
                  info: JSON.stringify({
                    cookie_enabled: Boolean(_0x19af39.cookie_enabled).toString()
                  }),
                  error: t.error ?? "",
                  timings: _0x33b2c3(_0x33b2c3({}, performance.timing.toJSON()), {}, {
                    jobStart: performance.getEntriesByName("jobStart")[0]?.["startTime"] || 0,
                    jobEnd: Date.now()
                  })
                });
                a = {
    ...
    var _0x11a5af = Object.assign(function (A, t) {
      var c = _0xc52c7c;
      clearTimeout(_0x11a5af.timerId);
      if (!_0x11a5af.sended) {
        var e;
        e = A != null && _0x247740(A) === "object" ? "error" in A ? A.error : "reason" in A ? A.reason : A : A;
        if (t) {
    ...
    function _0x3ea5dc() {
      ...
      class _0x3bbe57 {
        constructor() {
          ...
          this.ops[_0x18c581.ADD] = function (A) {
            ...
            var e = A.getByte();
            var n = A.getByte();
            A.setReg(c, A.getReg(e) + A.getReg(n));
          };
        ...
        ["run"]() {
          for (var A = _0x5c2718; this.regs[_0x19a465.BYTECODE_PTR] < this.bytecode.length;) {
            var t = this.getByte();
            var c = this.ops[t];
            try {
              c(this);
            } catch (c) {
              var e = "Current stack ptr: " + this.regs[_0x19a465.BYTECODE_PTR] + " op code: " + t;
              console.log(e);
        ...
        runFuncAt(A) {
          ...
          do {
            ...
            try {
              ...
              var n = "Current stack ptr: " + this.regs[_0x19a465.BYTECODE_PTR] + " op code: " + c;
              console.log(n);
          ...
          } while (!(_0x19a465.BCFUNC_RETURN in this.regs) && this.regs[_0x19a465.BYTECODE_PTR] < this.bytecode.length);
        ...
        ["_decodeBytecode"](A) {
          for (var t = _0x5c2718, c = atob(A), e = [], n = 0, r = 0; r < c.length; r++) {
        ...
        ["_loadString"]() {
          var A = _0x5c2718;
          for (var t = this.getByte() << 8 || this.getByte(), c = "", e = 0; e < t; e++) {
      ...
      _0x8c14c2.init("");
      _0x8c14c2.run();
    }
    ...
    const _0x110d38 = (...A) => {
      var t = _0xc52c7c;
      const [c, e, n] = A;
      return Promise.race([c, new Promise((A, c) => setTimeout(c, e, new Error("Promise timeout after " + e + "ms")))]).catch(c => A.length > 2 ? n : Promise.reject(c));
    };
    const _0x1d68a2 = () => Object();
    const _0x519cfd = () => {
      var A = _0xc52c7c;
      const t = ["Andale Mono", "Apple Braille", "Apple Chancery", "Apple Color Emoji", "Apple SD Gothic Neo", "Apple Symbols", "AppleGothic", "Arial", "Arial Black", "Arial Hebrew", "Arial MT", "Arial Narrow", "Arial Rounded MT Bold", "Arial Unicode MS", "Bitstream Vera Sans Mono", "Book Antiqua", "Bookman Old Style", "Calibri", "Cambria", "Cambria Math", "Century", "Century Gothic", "Century Schoolbook", "Comic Sans", "Comic Sans MS", "Consolas", "Courier", "Courier New", "Garamond", "Geneva", "Georgia", "Helvetica", "Helvetica Neue", "Impact", "Lucida Bright", "Lucida Calligraphy", "Lucida Console", "Lucida Fax", "Lucida Grande", "Lucida Handwriting", "Lucida Sans", "Lucida Sans Typewriter", "Lucida Sans Unicode", "MS Gothic", "MS Outlook", "MS PGothic", "MS Reference Sans Serif", "MS Sans Serif", "MS Serif", "MYRIAD", "MYRIAD PRO", "Microsoft Himalaya", "Microsoft JhengHei", "Microsoft Sans Serif", "Microsoft Tai Le", "Microsoft YaHei", "Microsoft Yi Baiti", "Monaco", "Monotype Corsiva", "Palatino", "Palatino Linotype", "Segoe Print", "Segoe Script", "Segoe UI", "Segoe UI Light", "Segoe UI Semibold", "Segoe UI Symbol", "Tahoma", "Times", "Times New Roman", "Times New Roman PS", "Trebuchet MS", "Verdana", "Webdings", "Wingdings", "Wingdings 2", "Wingdings 3"];
    ...
    const _0x10989d = Object.freeze(Object.defineProperty({
      __proto__: null,
    ...
    const _0x29e8f1 = A => {
      ...
      const o = (r, ...i) => {
        ...
        if (i.length !== 0) {
          var C;
          var l;
          n(String.fromCharCode.apply(String, i.map(A => A - r)));
        } else {
          const t = typeof r;
          if (t === "undefined") {
          ...
          if (r === null) {
            ...
            if (Number.isNaN(C) || !Number.isFinite(C)) {
              ...
              c.apply(null, C.toString().split("").map(A => A.charCodeAt(0)));
            }
          } else {
            if (t === "bigint") {
    ...
    var _0x1ba01b = typeof globalThis !== "undefined" ? globalThis : typeof window !== "undefined" ? window : typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : {};
    function _0x216268(A) {
      var t = _0xc52c7c;
      if (A && A.__esModule && Object.prototype.hasOwnProperty.call(A, "default")) {
        return A.default;
      } else {
        return A;
      }
    ...
    function _0x5d4ca5(A) {
      ...
      Object.keys(A).forEach(function (c) {
        ...
        Object.defineProperty(e, c, r.get ? r : {
          enumerable: true,
          get: function () {
            return A[c];
          }
    ...
    const _0x1cd978 = {};
    const _0x3a4af1 = Object.freeze(Object.defineProperty({
      __proto__: null,
      default: _0x1cd978
    }, Symbol.toStringTag, {
      value: "Module"
    ...
    function _0x573f18() {
      ...
      if (!_0x2cb031) {
        _0x2cb031 = 1;
        _0x226e2b.exports = (A = A || function (A, t) {
          var c;
          var e = _0x1206;
          ...
          var l = C.Hex = {
            ...
            parse: function (A) {
              ...
              for (var c = A.length, n = [], r = 0; r < c; r += 2) {
                n[r >>> 3] |= parseInt(A.substr(r, 2), 16) << 24 - r % 8 * 4;
              }
          ...
          var x = o.BufferedBlockAlgorithm = i.extend({
            ...
            _process: function (t) {
              ...
              var C = o / (i * 4);
              var l = (C = t ? A.ceil(C) : A.max((C | 0) - this._minBufferSize, 0)) * i;
              var s = A.min(l * 4, o);
              if (l) {
                for (var d = 0; d < l; d += i) {
    ...
    function _0x48fc61() {
      ...
      if (!_0x62ff66) {
        _0x62ff66 = 1;
        _0x2215ae.exports = (A = _0x573f18(), t = _0x1206, function () {
          var t = _0x1206;
          var c = A;
          ...
          function n(A, c, n) {
            ...
            for (var i = 0; i < c; i++) {
              if (i % 4) {
                var B = n[A.charCodeAt(i - 1)] << i % 4 * 2 | n[A.charCodeAt(i)] >>> 6 - i % 4 * 2;
                a[o >>> 2] |= B << 24 - o % 4 * 8;
                o++;
              }
            }
          ...
          c.enc.Base64 = {
            stringify: function (A) {
              ...
              var a = [];
              for (var o = 0; o < n; o += 3) {
                var i = (e[o >>> 2] >>> 24 - o % 4 * 8 & 255) << 16 | (e[o + 1 >>> 2] >>> 24 - (o + 1) % 4 * 8 & 255) << 8 | e[o + 2 >>> 2] >>> 24 - (o + 2) % 4 * 8 & 255;
          ...
          var B = o.MD5 = a.extend({
            ...
            _doProcessBlock: function (A, t) {
              ...
              for (var n = 0; n < 16; n++) {
                var r = t + n;
                var a = A[r];
                A[r] = (a << 8 | a >>> 24) & 16711935 | (a << 24 | a >>> 8) & -16711936;
              }
            ...
            _doFinalize: function () {
              ...
              var i = r;
              n[15 + (a + 64 >>> 9 << 4)] = (o << 8 | o >>> 24) & 16711935 | (o << 24 | o >>> 8) & -16711936;
              n[14 + (a + 64 >>> 9 << 4)] = (i << 8 | i >>> 24) & 16711935 | (i << 24 | i >>> 8) & -16711936;
              ...
              for (var l = 0; l < 4; l++) {
                var s = C[l];
                C[l] = (s << 8 | s >>> 24) & 16711935 | (s << 24 | s >>> 8) & -16711936;
              }
              return B;
            },
            clone: function () {
    ...
    function _0x33b66b() {
      ...
      if (!_0x4b8dc5) {
        _0x4b8dc5 = 1;
        _0x10bd4c.exports = (A = _0x573f18(), t = _0x1206, n = (e = A).lib, r = n.WordArray, a = n.Hasher, o = e.algo, i = [], B = o.SHA1 = a.extend({
          _doReset: function () {
            var A = c;
          ...
          _doProcessBlock: function (A, t) {
            ...
            for (var l = 0; l < 80; l++) {
              ...
              d += l < 20 ? 1518500249 + (a & o | ~a & B) : l < 40 ? 1859775393 + (a ^ o ^ B) : l < 60 ? (a & o | a & B | o & B) - 1894007588 : (a ^ o ^ B) - 899497514;
              C = B;
              B = o;
              o = a << 30 | a >>> 2;
              a = r;
        ...
        }), e.SHA1 = a._createHelper(B), e.HmacSHA1 = a._createHmacHelper(B), A.SHA1);
      }
    ...
    function _0x192342() {
      ...
      if (!_0x4c22b9) {
        _0x4c22b9 = 1;
        _0x28c288.exports = (A = _0x573f18(), _0x33b66b(), _0x3971c9(), t = _0x1206, n = (e = A).lib, r = n.Base, a = n.WordArray, o = e.algo, i = o.MD5, B = o.EvpKDF = r.extend({
          cfg: r.extend({
            keySize: 4,
            hasher: i,
            iterations: 1
          ...
          compute: function (A, t) {
            ...
            var i = a.create();
            for (var B = i.words, C = r.keySize, l = r.iterations; B.length < C;) {
              if (e) {
                o.update(e);
              }
    ...
    function _0x307c69() {
      ...
      if (_0x2b133a) {
        ...
        _0x2b133a = 1;
        _0x4417fd.exports = (A = _0x573f18(), _0x192342(), void (A.lib.Cipher || function (c) {
          var e = t;
          var n = A;
          var r = n.lib;
          var a = r.Base;
          ...
          var w = (n.pad = {}).Pkcs7 = {
            pad: function (A, t) {
              var c = e;
              var n = t * 4;
              for (var r = n - A.sigBytes % n, a = r << 24 | r << 16 | r << 8 | r, i = [], B = 0; B < r; B += 4) {
                i.push(a);
              }
              var C = o.create(i, r);
              A.concat(C);
          ...
          var _ = (n.format = {}).OpenSSL = {
            stringify: function (A) {
              ...
              var c = A.ciphertext;
              var n = A.salt;
              return (n ? o.create([1398893684, 1701076831]).concat(n).concat(c) : c).toString(C);
            },
            parse: function (A) {
              var t;
              var c = e;
          ...
          var g = r.PasswordBasedCipher = m.extend({
            ...
            encrypt: function (A, t, c, n) {
              var r = e;
              var a = (n = this.cfg.extend(n)).kdf.execute(c, A.keySize, A.ivSize);
              n.iv = a.iv;
    ...
    function _0x4b2897() {
      ...
      if (!_0x1e8255) {
        _0x1e8255 = 1;
        _0x1e4ec5.exports = (A = _0x573f18(), _0x48fc61(), _0x4b78ca(), _0x192342(), _0x307c69(), t = _0x1206, function () {
          var t = _0x1206;
          var c = A;
          ...
          var w = n.AES = e.extend({
            _doReset: function () {
              ...
              if (!this._nRounds || this._keyPriorReset !== this._key) {
                ...
                var e = c.words;
                var n = c.sigBytes / 4;
                for (var a = ((this._nRounds = n + 6) + 1) * 4, o = this._keySchedule = [], i = 0; i < a; i++) {
                  if (i < n) {
                    o[i] = e[i];
                  } else {
                    w = o[i - 1];
                    if (i % n) {
                      if (n > 6 && i % n == 4) {
                        w = r[w >>> 24] << 24 | r[w >>> 16 & 255] << 16 | r[w >>> 8 & 255] << 8 | r[w & 255];
                      }
                    } else {
                      w = r[(w = w << 8 | w >>> 24) >>> 24] << 24 | r[w >>> 16 & 255] << 16 | r[w >>> 8 & 255] << 8 | r[w & 255];
                      w ^= Q[i / n | 0] << 24;
                    }
                    o[i] = o[i - n] ^ w;
                  }
                ...
                for (var C = 0; C < a; C++) {
                  ...
                  B[C] = C < 4 || i <= 4 ? w : l[r[w >>> 24]] ^ s[r[w >>> 16 & 255]] ^ d[r[w >>> 8 & 255]] ^ x[r[w & 255]];
                }
              }
            },
            ...
            _doCryptBlock: function (A, t, c, e, n, r, a, o) {
              for (var i = this._nRounds, B = A[t] ^ c[0], C = A[t + 1] ^ c[1], l = A[t + 2] ^ c[2], s = A[t + 3] ^ c[3], d = 4, x = 1; x < i; x++) {
                var Q = e[B >>> 24] ^ n[C >>> 16 & 255] ^ r[l >>> 8 & 255] ^ a[s & 255] ^ c[d++];
                var w = e[C >>> 24] ^ n[l >>> 16 & 255] ^ r[s >>> 8 & 255] ^ a[B & 255] ^ c[d++];
                var b = e[l >>> 24] ^ n[s >>> 16 & 255] ^ r[B >>> 8 & 255] ^ a[C & 255] ^ c[d++];
                var _ = e[s >>> 24] ^ n[B >>> 16 & 255] ^ r[C >>> 8 & 255] ^ a[l & 255] ^ c[d++];
                B = Q;
                C = w;
                l = b;
                s = _;
              }
              Q = (o[B >>> 24] << 24 | o[C >>> 16 & 255] << 16 | o[l >>> 8 & 255] << 8 | o[s & 255]) ^ c[d++];
              w = (o[C >>> 24] << 24 | o[l >>> 16 & 255] << 16 | o[s >>> 8 & 255] << 8 | o[B & 255]) ^ c[d++];
              b = (o[l >>> 24] << 24 | o[s >>> 16 & 255] << 16 | o[B >>> 8 & 255] << 8 | o[C & 255]) ^ c[d++];
              _ = (o[s >>> 24] << 24 | o[B >>> 16 & 255] << 16 | o[C >>> 8 & 255] << 8 | o[l & 255]) ^ c[d++];
              A[t] = Q;
              A[t + 1] = w;
              A[t + 2] = b;
              A[t + 3] = _;
      ...
      hbs: {
        stringify: function (A) {
          for (var t = _0xc52c7c, c = [], e = 0; e < A.sigBytes; e++) {
            var n = (A.words[e >>> 2] >>> 24 - e % 4 * 8 & 255).toString(2);
    ...
    function _0x34b34b(A) {
      var t = _0xc52c7c;
      if (_0x3ca8c1(Symbol) === "function" && _0x3ca8c1(Symbol.iterator) !== "symbol" && A && A.constructor === Symbol && A !== Symbol.prototype) {
        return "symbol";
      } else {
        return _0x3ca8c1(A);
      }
    ...
    function _0x55d37b(A) {
      ...
      return c.indexOf("native code") !== -1 && c.indexOf("return") === -1 && c.indexOf("=>") === -1 && c.indexOf('"') === -1 && c.indexOf("'") === -1;
    }
    function _0xfb387(A) {
    ...
    function _0x154762(A, t) {
      ...
      throw _0x21ad99(TypeError, "Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
    }
      ...
      try {
        ...
        if (_0x3ca8c1(A) === "function" && _0x652933(e.DUMP_FUNCTION_AS_OBJ)) {
          if (_0x652933(_0xfb387(A))) {
            return {
              value: Function.prototype.toString.call(A).substring(0, e.FUNCTION_MAX_DUMP_LEN)
            };
        ...
        try {
          ...
          if (t instanceof Error) {
            t.message += "- typeof val1 \"" + typeof A + "\" - val1 \"" + String(A) + '"';
          }
          throw t;
        }
        ...
        if (_0x3ca8c1(A) === "function") {
          i["@f"] = Function.prototype.toString.call(A).substring(0, e.FUNCTION_MAX_DUMP_LEN);
        }
        if (Array.isArray(A)) {
        ...
        for (let o = 0; o < C.length; o++) {
          ...
          if (!s) {
            i["@val:" + l] = "__SERIALIZE_ERROR__: Could not get property descriptor - property \"" + l + ' - "' + String(A) + '"';
            continue;
          }
          const d = parseInt(l);
          if ((!_0x652933(isNaN(d)) || !(d > 10)) && !l.startsWith("Symbol(meta)")) {
            if (s.get !== undefined) {
              try {
                if (_0x652933(_0xfb387(s.get)) || _0x5303bf(s.get)) {
                  i["@getter:" + l] = Function.prototype.toString.call(s.get).substring(0, e.FUNCTION_MAX_DUMP_LEN);
                }
    ...
    async function _0x409816() {
      ...
      _0x3ea5dc();
      return await window.runChallenge();
    }
    function _0x321cc5() {
      var A = _0xc52c7c;
    ...
    function _0x31da88() {
      var A = _0xc52c7c;
      return (_0x31da88 = _0x433d14(_0x1a6645().m(function A() {
        var t;
        var c;
        var e;
        var n;
